...
function UPDATE_ELEMENT_DOG_BREEDS_LIST(state, dogToUpdate) {
...
function UPDATE_ELEMENT_DOGS_LIST_BY_BREED(state, dogToUpdate) {
...
function updateFavoriteState(state, { dog, favoriteState }) {
